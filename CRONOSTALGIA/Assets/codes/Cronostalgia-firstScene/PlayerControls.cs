...
public class PlayerControls : MonoBehaviour {
    ...
    void Start()
    {
        ...
        titulos = GameObject.FindGameObjectsWithTag("title");
        titulos[0].GetComponent<SpriteRenderer>().enabled = true;
        titulos[1].GetComponent<SpriteRenderer>().enabled = false;
    }
    ...
    void TimeLeap()
    {
        if (en_presente)
        {
            ...
            titulos[1].GetComponent<SpriteRenderer>().enabled = true;
            titulos[0].GetComponent<SpriteRenderer>().enabled = false;
